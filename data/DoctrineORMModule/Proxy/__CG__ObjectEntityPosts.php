 ...
 */
class Posts extends \Object\Entity\Posts implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Object\\Entity\\Posts' . "\0" . 'id', '' . "\0" . 'Object\\Entity\\Posts' . "\0" . 'name', '' . "\0" . 'Object\\Entity\\Posts' . "\0" . 'shortName', '' . "\0" . 'Object\\Entity\\Posts' . "\0" . 'description');
        }
