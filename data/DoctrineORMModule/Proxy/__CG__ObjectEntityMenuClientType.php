 ...
 */
class MenuClientType extends \Object\Entity\MenuClientType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Object\\Entity\\MenuClientType' . "\0" . 'id', '' . "\0" . 'Object\\Entity\\MenuClientType' . "\0" . 'name', 'inputFilter', 'EntityName');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MenuClientType $proxy) {
