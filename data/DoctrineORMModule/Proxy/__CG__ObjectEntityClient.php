 ...
 */
class Client extends \Object\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Object\\Entity\\Client' . "\0" . 'id', '' . "\0" . 'Object\\Entity\\Client' . "\0" . 'fullName', '' . "\0" . 'Object\\Entity\\Client' . "\0" . 'identificationNumber', '' . "\0" . 'Object\\Entity\\Client' . "\0" . 'isExternal', 'personInfo', 'unitInfo', 'nodes', '' . "\0" . 'Object\\Entity\\Client' . "\0" . 'address', 'inputFilter', 'EntityName');
        }
