 ...
 */
class UrgencyType extends \Object\Entity\UrgencyType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Object\\Entity\\UrgencyType' . "\0" . 'id', '' . "\0" . 'Object\\Entity\\UrgencyType' . "\0" . 'name', '' . "\0" . 'Object\\Entity\\UrgencyType' . "\0" . 'shortName', '' . "\0" . 'Object\\Entity\\UrgencyType' . "\0" . 'level', 'inputFilter', 'EntityName');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UrgencyType $proxy) {
