 ...
 */
class Sex extends \Object\Entity\Sex implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Object\\Entity\\Sex' . "\0" . 'id', '' . "\0" . 'Object\\Entity\\Sex' . "\0" . 'name', '' . "\0" . 'Object\\Entity\\Sex' . "\0" . 'shortName', '' . "\0" . 'Object\\Entity\\Sex' . "\0" . 'person', 'inputFilter', 'EntityName');
        }
