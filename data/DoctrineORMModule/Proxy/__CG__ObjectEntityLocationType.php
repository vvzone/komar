 ...
 */
class LocationType extends \Object\Entity\LocationType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Object\\Entity\\LocationType' . "\0" . 'id', '' . "\0" . 'Object\\Entity\\LocationType' . "\0" . 'name', '' . "\0" . 'Object\\Entity\\LocationType' . "\0" . 'shortName', 'inputFilter', 'EntityName');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LocationType $proxy) {
