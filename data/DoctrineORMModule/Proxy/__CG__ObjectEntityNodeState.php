 ...
 */
class NodeState extends \Object\Entity\NodeState implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Object\\Entity\\NodeState' . "\0" . 'id', '' . "\0" . 'Object\\Entity\\NodeState' . "\0" . 'code', '' . "\0" . 'Object\\Entity\\NodeState' . "\0" . 'codeName', '' . "\0" . 'Object\\Entity\\NodeState' . "\0" . 'name');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NodeState $proxy) {
