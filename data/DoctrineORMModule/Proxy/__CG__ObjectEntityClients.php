...
class Clients extends \Object\Entity\Clients implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Object\\Entity\\Clients' . "\0" . 'id', '' . "\0" . 'Object\\Entity\\Clients' . "\0" . 'fullName', '' . "\0" . 'Object\\Entity\\Clients' . "\0" . 'identificationNumber', '' . "\0" . 'Object\\Entity\\Clients' . "\0" . 'isExternal', '' . "\0" . 'Object\\Entity\\Clients' . "\0" . 'person_id', 'personInfo');
        }
