 ...
 */
class CurrentDocumentType extends \Object\Entity\CurrentDocumentType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CurrentDocumentType $proxy) {
    ...
    public function getCurrentDocumentTypeSimple()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCurrentDocumentTypeSimple', array());

        return parent::getCurrentDocumentTypeSimple();
    }
