 ...
 */
class SecrecyType extends \Object\Entity\SecrecyType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Object\\Entity\\SecrecyType' . "\0" . 'id', '' . "\0" . 'Object\\Entity\\SecrecyType' . "\0" . 'name', '' . "\0" . 'Object\\Entity\\SecrecyType' . "\0" . 'shortName', '' . "\0" . 'Object\\Entity\\SecrecyType' . "\0" . 'singleNumeration', '' . "\0" . 'Object\\Entity\\SecrecyType' . "\0" . 'level', 'inputFilter', 'EntityName');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SecrecyType $proxy) {
    ...
    public function setSingleNumeration($singleNumeration)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSingleNumeration', array($singleNumeration));

        return parent::setSingleNumeration($singleNumeration);
    }
    ...
    public function getSingleNumeration()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSingleNumeration', array());

        return parent::getSingleNumeration();
    }
