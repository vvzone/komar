 ...
 */
class RegionType extends \Object\Entity\RegionType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RegionType $proxy) {
    ...
    public function getRegionTypeSimple()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRegionTypeSimple', array());

        return parent::getRegionTypeSimple();
    }
