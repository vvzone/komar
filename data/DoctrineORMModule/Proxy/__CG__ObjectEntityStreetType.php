 ...
 */
class StreetType extends \Object\Entity\StreetType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Object\\Entity\\StreetType' . "\0" . 'id', '' . "\0" . 'Object\\Entity\\StreetType' . "\0" . 'name', '' . "\0" . 'Object\\Entity\\StreetType' . "\0" . 'shortName', 'inputFilter', 'EntityName');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StreetType $proxy) {
    ...
    public function getStreeTypeSimple()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getStreeTypeSimple', array());

        return parent::getStreeTypeSimple();
    }
