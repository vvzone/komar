...
class RegionTypeController extends RestController
{
    ...
    public function getList()
    {
        $serviceLocator = $this
            ->getServiceLocator();
        $result = $serviceLocator->get('Doctrine\ORM\RegionTypeRESTListPagination');
        return $result;
    }
    ...
    public function get($id)
    {
        ...
        $post = $objectManager->find('Object\Entity\RegionType', $id);
    ...
    public function create($data)
    {
        ...
        if($inputFilter->setData($data)->isValid()){
            $hydrator = new DoctrineHydrator($objectManager,'Object\Entity\RegionType');
