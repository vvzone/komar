...
class DocumentTypeRepository extends EntityRepository implements ServiceLocatorAwareInterface
{
    protected $services;
    ...
    public function count()
    {
        ...
        $query->select(array('r.id'))
            ->from('Object\Entity\DocumentType', 'r');
    ...
    public function getItems($offset, $itemCountPerPage)
    {
        ...
        $query->select(array('p.id', 'p.name'))
            ->from('Object\Entity\DocumentType', 'p')
