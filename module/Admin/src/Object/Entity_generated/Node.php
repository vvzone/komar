 ...
 * Node
 *
 * @ORM\Table(name="node", indexes={@ORM\Index(name="fk_node_node_level1_idx", columns={"node_level_id"}), @ORM\Index(name="fk_node_client1_idx", columns={"client_id"}), @ORM\Index(name="node_state_id", columns={"node_state_id"})})
 * @ORM\Entity
 */
class Node
{
     ...
     * @return Node
     */
    public function setNodeState(\Object\Entity\NodeState $nodeState = null)
    {
