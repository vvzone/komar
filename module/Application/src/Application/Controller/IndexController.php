    ...
    public function ajaxAction(){
        ...
        $array_base = array(
            ...
            array('id' => 105, 'category' => 'base', 'entity' => 'enumeration_types', 'screen' => 'sys_docs', 'name' => 'Типы нумерации',
                'isNonIndependent' => true ),
            array('id' => 105, 'category' => 'base', 'entity' => 'doc_types', 'screen' => 'sys_docs', 'name' => 'Типы документов',
                'isNonIndependent' => true ),
            array('id' => 105, 'category' => 'base', 'entity' => 'node_types', 'screen' => 'sys_docs', 'name' => 'Типы узлов маршрута',
                'isNonIndependent' => true ),
            array('id' => 105, 'category' => 'base', 'entity' => 'doc_attributes_types', 'screen' => 'sys_docs', 'name' => 'Типы аттрибутов',
                'isNonIndependent' => true ),
            array('id' => 105, 'category' => 'base', 'entity' => 'enumeration', 'screen' => 'sys_docs', 'name' => 'Нумерация',
                'isNonIndependent' => true ),
        );
