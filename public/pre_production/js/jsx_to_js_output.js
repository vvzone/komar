...
var MainList = React. createClass({displayName: 'MainList',
    ...
    render: function () {
        ...
        instant_search_box[0] = React.DOM.div({className: "InstantSeacrh"}, InstantSearch({source: this.props.source, searchReceived: this.searchReceived}));

        list_header[0] = instant_search_box;
        list_header[1] = React.DOM.div({className: "ButtonAdd"}, ButtonAdd({clicked: self.whenClickedCP}));
        return(
            React.DOM.div({className: "List"}, 
                React.DOM.div({className: "ListHeader"}, list_header), 
...
var MainScreen = React.createClass({displayName: 'MainScreen',
    ...
    render: function(){
        return(
            React.DOM.div({className: "MainScreen"}, 
