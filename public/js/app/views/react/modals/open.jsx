...
define(
    ...
    [
        ...
        'jsx!views/react/item_open',
        'event_bus'
    ],function($, _, Backbone, React, ModalWindowBase, MainItemOpen, EventBus){

        var ModalWindowOpen = React.createClass({
            ...
            callback: function(action){
                console.info('Modal Open Window callback from MaiItemOpen..., action:');
                console.info(action);
                if(action == 'save'){
                    this.refs.modal.hide();
                }
            ...
            render: function(){
                ...
                console.log('ModalWindowOpen, this.props.model:');
                ...
                return(
                    ...
                    buttons={buttons}
                    >
                        <MainItemOpen ref="item_open" model={this.props.model} callback={this.callback} />
                    </ModalWindowBase>
                    );
