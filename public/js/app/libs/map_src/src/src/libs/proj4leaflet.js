    ...
    L.Proj.CRS = L.Class.extend({
        ...
        initialize: function(a, b, c) {
            ...
            if (this.options.scales) {
                ...
                this.resolutions = [];
                for (var i = this.options._scales.length - 1; i >= 0; i--) {
                    if (this.options._scales[i]) {
                        this.resolutions[i] = 1 / this.options._scales[i];
                    }
                }
        ...
        _calculateSizes: function() {
            ...
            for (i = resolutions.length - 1; i >= 0; i--) {
                if (resolutions[i]) {
                    ...
                    x = Math.ceil(parseFloat((crsBounds[2] - crsBounds[0]) / resolutions[i]).toPrecision(3));
                    y = Math.ceil(parseFloat((crsBounds[3] - crsBounds[1]) / resolutions[i]).toPrecision(3));
                    sizes[i] = L.point(x, y);
                }
            }
